...
function PendingWalletList({ allowners, loading, setPage, limit, setLimit ,status}) {
    ...
    <div className="d-flex align-items-center" style={{ gap: "5px" }}>
      {/* Redirects to Car details */}
        ...
        <Tooltip title={ "common.edit"} placement="top">
          <Link to={`/app/wallet/${id}`}>
            <button className="border-0" style={{background:"##7EA831",color:"#7EA831",cursor:"pointer"}}>
            تأكيد معاملة
            </button>
          </Link>
        </Tooltip>
...
export default PendingWalletList;
