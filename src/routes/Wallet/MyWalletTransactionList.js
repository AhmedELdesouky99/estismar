...
import { MyWalletTransactionData } from "./MyWalletTransactionData";
...
function MyWalletTransactionList({ allowners, loading, setPage, limit, setLimit ,status}) {
  ...
  useEffect(() => {
    console.log( allowners," allowners?.data")
    setOwners({
    ...
    <Typography component="div" style={{ padding: "10px", marginTop: "20px" }}>
      <div>
        <RctCollapsibleCard fullBlock table>
          <CustomTable
            tableData={MyWalletTransactionData}
            loading={loading}
...
MyWalletTransactionList.propTypes = {
...
export default MyWalletTransactionList;
