...
import { WalletTransactionsData } from "./WalletDataTransactions";
...
function AllWalletTransactions({ allowners, loading, setPage, limit, setLimit ,status}) {
...
AllWalletTransactions.propTypes = {
