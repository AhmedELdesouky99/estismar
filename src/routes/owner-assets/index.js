...
import OwnerAssets from "./ownersAssets"
import AddEditOwnersAssets from "./AddEditOwnerAssets/index"
   ...
   <div className="Crm-wrapper">
      <Switch>
        {console.log(match,"match")}
         ...
         <Route exact path={`${match.url}/`} component={OwnerAssets} />
         <Route exact path={`${match.url}/project-detail/:id`} component={AsyncProjectDetailComponent} />
         <Route exact path={`${match.url}/clients`} component={AsyncClientsComponent} />
         <Route exact path={`${match.url}/reports`} component={AsyncReportsComponent} />
         <Route exact path={`${match.url}/add`} component={AddEditOwnersAssets} />
         <Route exact path={`${match.url}/:id`} component={AddEditOwnersAssets} />
