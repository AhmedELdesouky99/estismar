...
const Signin = () => {
  ...
  return (
    ...
    <div
      className='row'
      style={{ height: "100vh", textAlign: "right", direction: "ltr" }}
    >
      <div
        className='col-md-8 col-sm-12'
        style={{ margin: "auto", direction: "rtl", padding: "50px" }}
      >
        ...
        {errors ? (
          <div className='col-md-5 col-sm-12 alert alert-danger'>{errors}</div>
        ) : null}
      ...
      <div
        className='col-md-4 col-sm-12 logo'
        style={{ backgroundColor: "#150941" }}
      >
